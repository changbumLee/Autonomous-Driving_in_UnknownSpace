    ...
    return LaunchDescription(
        [
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    "model": LaunchConfiguration("model", default="/home/changbeom/ex_ws/src/yolo_ros/yolo_bringup/launch/lying_best.pt"),
                    ...
                    "input_image_topic": LaunchConfiguration(
                        "input_image_topic", default="/ugv_cam/image_raw"
                    ),
