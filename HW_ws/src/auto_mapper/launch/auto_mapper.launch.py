...
def create_slam_toolbox_node(package_name: str, is_sim: LaunchConfiguration) -> object:
    ...
    return IncludeLaunchDescription(
        ...
        launch_arguments={'use_sim_time': is_sim, 'slam_params_file': params_file}.items()
    )
    ...
    return [
        GroupAction(
            actions=[
                ...
                # create_slam_toolbox_node(package_name, is_sim),
                # nav2_bringup,
                auto_mapper,
                Node(
                    package="rviz2",
