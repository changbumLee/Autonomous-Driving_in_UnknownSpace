    ...
    return LaunchDescription(
        [
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    "model": LaunchConfiguration("model", default="/home/hjm/final_ws/yahboomcar_ws/function_package_with_WiFi_module/yahboomcar_ws/src/yolo_ros/yolo_bringup/launch/lying_best.pt"),
                    ...
                    "input_image_topic": LaunchConfiguration(
                        "input_image_topic", default="/esp32_img"
                    ),
